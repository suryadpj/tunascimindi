                            ...
                            <table width="100%">
                                <tr align="center">
                                    <td><button id="btn-1" type="button"
                                            class="disable btn btn-primary btn-style btn-frm btn-form-active"
                                            onclick="OnMenuClick(this)"><b>MERK</b></button></td>
                                    <td><button id="btn-2" type="button"
                                            class="btn btn-primary btn-style btn-frm btn-form-readonly"
    ...
    <script>
        ...
        function OnMenuClick(ele) {
            ...
            if (countform == 1) {
                ...
                $('#rootComponent').load('tradein/merk/' + selectedCarMerk + '/models/' + selectedCarModel + '/years/' + selectedCarYear + '/variants');
            } else if (countform == 4) {
                $('#rootComponent').load('tradein/merk/' + selectedCarMerk + '/models/' + selectedCarModel + '/years/' + selectedCarYear + '/variants/' +
