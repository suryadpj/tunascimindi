...
@section('content')
    ...
    <div class="row mb-4">
        ...
        <div class="col align-self-center ps-0">
            <h4 class="text-color-theme"><span class="fw-normal">Halo Wilujeng Sumping </span>, {{ auth::user()->name }} {{ $profil->no_polisi }}</h4>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <p class="mb-0 text-muted size-7">Batas perbaikan : 13 September 2022</p>
                                    </div>
                                </div>
                                <br>
                                <div class="row">
                                    <div class="col align-self-center text-end">
                                        <p class="small">
                                            <a href="index.php" class="btn btn-success">Book Now</a>
                                        </p>
                                    </div>
    ...
    <div class="py-5 mt-3">
        <h1 class="color-blue" align="center"><b>MENGAPA TUNAS TOYOTA ?</b></h1>
    </div>
    <div class="row py-3 mb-5">
        <div class="col-md-4 col-12 py-3">
            <div class="card form-style p-5 h-100 bg-white">
    ...
    <div class="bg-red py-3">
      <div class="container">
          <center>
              ...
              <div class="py-3">
                  <a href="#"><img class="img-fluid mx-3" src="https://tunastoyotacimindi.com/assets/img/facebook.png" alt="facebook.png" width="35"></a>
              ...
              <div class="py-3 "><div class="hr-white"></div></div>
