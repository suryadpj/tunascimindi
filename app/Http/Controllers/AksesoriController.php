...
class AksesoriController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('aksesoris',['brosur' => $segmen_brosur,'slideraks' => $segmen_aksesoris,'profil' => $profil,'lastservice' => $lastservice,'lastservicecount' => $lastservicecount,'cr7data' => $cr7data,'cr7count' => $cr7count]);
    }
