...
class AksesoriController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('aksesoris',['slideraks' => $segmen_aksesoris,'profil' => $profil,'lastservice' => $lastservice,'lastservicecount' => $lastservicecount,'cr7data' => $cr7data,'cr7count' => $cr7count]);
    }
