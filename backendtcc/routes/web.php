...
Route::get('/ecatalog/brosur/{id}', [EcatalogController::class, 'showbrosur'])->name('ecatalog.showbrosur');
Route::post('/ecatalog/brosur/update', [EcatalogController::class, 'updatebrosur'])->name('ecatalog.updatebrosur');
Route::DELETE('/ecatalog/brosur/{id}', [EcatalogController::class, 'destroybrosur'])->name('ecatalog.destroybrosur');

Route::resource('/dataedukasi', EdukasiController::class);
// Route::get('/dataedukasi/{id}', [MediaEdukasiController::class, 'show'])->name('dataedukasi.show');
...
// Route::delete('dataedukasihapus/{$id}', [MediaEdukasiController::class, 'destroy'])->name('dataedukasi.destroy');
