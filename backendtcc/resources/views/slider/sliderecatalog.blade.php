...
@section('content_header')
    <h1 class="m-0 text-dark">Slider E-Catalog</h1>
@stop
                        ...
                        <div class="col-sm-7">
                            <select class="form-control select2" name="segmen" id="segmen"  style="width: 100%;">
                                <option value=''>Pilih Segmen</option>
                                    <option value="4">E-Catalog</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
...
//data catatan
    ...
    $('#sample_form2').on('submit', function(event){
        ...
        if($('#action').val() == "Edit")
        {
            ...
            $.ajax({
                url:"{{ route('ecatalogslider.updated') }}",
                method:"POST",
                data:new FormData(this),
                contentType: false,
                cache: false,
