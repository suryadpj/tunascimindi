            ...
            <form method="post" id="sample_form2" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <select class="form-control select2" name="rekomendasi" id="rekomendasi"  style="width: 100%;">
                    ...
                    <div class="form-group row">
                        <label for="perihal" class="col-sm-5 col-form-label">Nama Promo</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="judul" id="judul" placeholder="Perihal">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="perihal" class="col-sm-5 col-form-label">Penjelasan Promo</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="penjelasan" id="penjelasan" placeholder="Perihal">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="formFile"  class="col-sm-5 col-form-label">Upload Gambar Promosi</label>
                        <div class="col-sm-7">
