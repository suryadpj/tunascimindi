...
@section('content_header')
    <h1 class="m-0 text-dark">Media Edukasi</h1>
@stop
            ...
            <form method="post" id="sample_form2" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        <label for="perihal" class="col-sm-5 col-form-label">Judul</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="judul" id="judul" placeholder="Judul Media Edukasi">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="perihal" class="col-sm-5 col-form-label">penjelasan</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="penjelasan" id="penjelasan" placeholder="Penjelasan singkat edukasi">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="formFile"  class="col-sm-5 col-form-label">Upload Media Edukasi</label>
                        <div class="col-sm-7">
    ...
    $(document).on('click', '.edit', function(){
        ...
        $.ajax({
            ...
            success:function(html)
            {
                ...
                $('.modal-title').text("Edit Media Edukasi");
