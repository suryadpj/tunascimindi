...
@section('title', 'CR7 Data')

@section('content_header')
    <h1 class="m-0 text-dark">CR7 Data</h1>
@stop
                ...
                <div class="row">
                    <div class="col-sm-2">
                        <div class="form-group">
                            <input type="text" autocomplete="off" class="form-control" name="search_nomor_polisi" placeholder="Nomor Polisi">
                        </div>
                    </div>
                    <div class="col-sm-2">
                        <div class="form-group">
            ...
            <form method="post" id="sample_form2" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        <label for="formFile"  class="col-sm-5 col-form-label">Upload File CR7</label>
                        <div class="col-sm-7">
...
$(document).ready(function(){
    ...
    var oTable = $('#user_table').DataTable({
        ...
        ajax:{
            url: "{{ route('cr7.index') }}",
            data: function (d) {
                d.nopolisi = $('input[name=search_nomor_polisi]').val();
                d.keterangan = $('input[name=search_keterangan]').val();
                d.eta = $('input[name=search_tanggaleta]').val();
                d.statuspart = $("#search_statuspart option:selected").val();
            }
        },
        columns: [
            {"data":"ID"},
...
//data catatan
    $('#create_record').click(function(){
        ...
        $('.modal-title').text("Upload File CR7");
