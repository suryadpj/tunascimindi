...
@section('content_header')
    <h1 class="m-0 text-dark">Data Aksesoris</h1>
@stop
            ...
            <form method="post" id="sample_form2" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        <label for="perihal" class="col-sm-5 col-form-label">Nama Aksesoris</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="judul" id="judul" placeholder="Perihal">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="perihal" class="col-sm-5 col-form-label">Penjelasan Aksesoris</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="penjelasan" id="penjelasan" placeholder="Perihal">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="formFile"  class="col-sm-5 col-form-label">Upload Gambar Icon</label>
                        <div class="col-sm-7">
                    ...
                    <div class="form-group row">
                        <label for="formFile"  class="col-sm-5 col-form-label">Upload File Lampiran Aksesoris</label>
                        <div class="col-sm-7">
                            <span id="lampiran2"></span>
                            <input class="form-control" type="file" name="file2" id="formFile" accept="image/jpeg,image/png,image/jpg,application/pdf">
                        </div>
                    </div>
                </div>
...
//data catatan
    $('#create_record').click(function(){
        ...
        $('.modal-title').text("Add Data Aksesoris Baru");
    ...
    $('#sample_form2').on('submit', function(event){
        ...
        if($('#action').val() == "Edit")
        {
            ...
            $.ajax({
                url:"{{ route('dataaksesoris.updated') }}",
                method:"POST",
                data:new FormData(this),
                contentType: false,
                cache: false,
    ...
    $(document).on('click', '.edit', function(){
        ...
        $.ajax({
            ...
            success:function(html)
            {
                ...
                if(html.data.link != "")
                {
                    $('#lampiran2').html('<a href="../' + html.data.link + '">' + html.data.link_name + '</a>');
                }
                else
                {
                    $('#lampiran2').html('');
                ...
                $('.modal-title').text("Edit Data Aksesoris");
