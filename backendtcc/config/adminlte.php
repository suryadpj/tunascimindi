        ...
        'Datatables' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'https://cdn.datatables.net/v/dt/dt-1.10.16/sl-1.2.5/datatables.min.js',
                ],
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => 'https://cdn.datatables.net/v/dt/dt-1.10.16/sl-1.2.5/datatables.min.css',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
